...
// ⚡ Bolt Optimization: Memoize the library problem row to prevent synchronous
// re-rendering of the entire list when unrelated state (like the deferred search query) changes.
// The shallow comparison skips diffing unchanged rows, keeping typing responsive.
const LibraryProblemRowItem = memo(function LibraryProblemRowItem(props: {
